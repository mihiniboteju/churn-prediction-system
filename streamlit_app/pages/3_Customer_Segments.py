...
with col1:
    ...
    **Customer Profile:**
    ...
    - **Tenure:** Below average (shorter relationships)
    - **Monthly Charges:** Below average (lower spending)
    - **Total Charges:** Below average (less lifetime value)
    - **Churn Risk:** 29.7% - Nearly 1 in 3 will churn
    
    **Behavioral Patterns:**
    
    - Likely newer customers still evaluating service
    - Price-sensitive decision makers
    - Month-to-month contracts more common
    - Lower service bundle adoption
    - Higher electronic check payment usage
    
    **Retention Strategy:**
    
    **Immediate Actions:**
    
    - **Onboarding Enhancement:** First 90-day engagement program
    ...
    - **Usage Education:** Help maximize service value
    
    **Pricing Tactics:**
    
    - Welcome discounts (first 3 months)
    - Bundle package promotions
    - Price-lock guarantees for contract upgrades
    - Auto-pay discounts (5-10%)
    
    **Business Priority: CRITICAL**
    
    - Largest segment with highest churn rate
...
with col2:
    ...
    **Customer Profile:**
    ...
    - **Tenure:** Above average (longer relationships)
    - **Monthly Charges:** Above average (higher spending)
    - **Total Charges:** Above average (greater lifetime value)
    - **Churn Risk:** 22.4% - More stable, but still need attention
    
    **Behavioral Patterns:**
    
    - Established customers with longer tenure
    ...
    **Loyalty & Growth:**
    ...
    - **Loyalty Rewards:** Anniversary bonuses and exclusive perks
    ...
    - **Contract Renewal:** Early renewal incentives
    
    **Value Enhancement:**
    
    - Tenure-based rewards (every 12 months)
    ...
    **Business Priority: HIGH VALUE**
    ...
    - Smaller segment but higher per-customer revenue
...
with comparison_col2:
    ...
    st.markdown(""" 
    **Key Insight:** Segment 0 has **7.3 percentage points higher churn** than Segment 1, 
...
with tab1:
    ...
    with col2:
        ...
        **Primary Goals:**
        ...
        - Reduce churn from 29.7% to < 22%
        - Convert 40% to annual contracts
        - Increase auto-pay adoption to 60%
        - 4.2+ satisfaction score (NPS)
        
        **Financial Impact:**
        
        - Save ~290 customers/year
    ...
    st.markdown("---")
    st.markdown("""
    **Key Insight:** Focus on first 90 days. Data shows tenure is below average in this segment - converting month-to-month to annual contracts reduces churn by ~50%.
    """)
...
with tab2:
    ...
    with col2:
        ...
        **Primary Goals:**
        ...
        - Reduce churn from 22.4% to < 15%
        - 75% contract renewal rate
        - 20% upsell success rate
        - 4.7+ satisfaction score (NPS)
        
        **Growth Targets:**
        
        - Increase ARPU by 15%
        - 30% cross-sell adoption
        - 50% referral participation
        
        **Financial Impact:**
        
        - Save ~230 customers/year
    ...
    st.markdown("---")
    st.markdown("""
    **Key Insight:** This segment already shows loyalty (higher tenure, higher spend). 
